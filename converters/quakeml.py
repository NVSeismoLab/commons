# -*- coding: utf-8 -*-
#
# NOTE: This file is a copy of an experimental ObsPy branch
#       It will go away in the future and an import of the
#       real ObsPy version should happen instead. -MCW
# eventually from obspy.core.quakeml import Pickler, etc
"""
...
class Pickler(object):
    ...
    def _origin(self, origin):
        ...
        if ou is not None:
            ...
            # aded by MCW, 2013-05-30
            if hasattr(ou, 'confidence_level'):
                self._str(ou.confidence_level, ou_el, 'confidenceLevel')
